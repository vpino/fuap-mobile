...
const HomeLoan7assets = () => {
  const navigation = useNavigation<StackNavigationProp<ParamListBase>>();

  return (
    <View style={styles.homeLoan7assets}>
      <View style={styles.plQuestions}>
        ...
        <Text style={styles.text}>
          <Text style={styles.paso7}>{`Paso 7 `}</Text>
        ...
        <FrameComponent1
          ...
          onFramePressablePress={() => navigation.navigate("HomeLoan8TCs")}
        />
      </View>
      <HeaderFooter
...
export default HomeLoan7assets;
