...
interface AcceptTermConditionsFormProps {}

export const AcceptTermConditionsForm: React.FC<
  AcceptTermConditionsFormProps
> = () => {
  const {personalLoan} = usePersonalLoanStore();
  const {updateTermsAndConditions} = usePersonalLoan({
    id: personalLoan.id ?? '',
  });
