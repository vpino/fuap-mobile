...
const Step3ConnectedHomeRepayment = () => {
  const navigation = useNavigation<StackNavigationProp<ParamListBase>>();

  return (
    <View style={styles.step3ConnectedHomeRepaymen}>
      <HeaderFooter
        ...
        <View style={styles.personalText}>
          <View style={styles.frameParent}>
            <View style={styles.frameGroup}>
              <View
                style={[
                  styles.prstamoDeCasaWrapper,
                  styles.loanDetailsPosition,
                ]}
              >
                <Text
                  style={[styles.prstamoDeCasa, styles.fechaDePagoClr]}
      ...
      <View
        style={[styles.step3ConnectedHomeRepaymenChild, styles.step3Position]}
      />
      <View style={[styles.loanDetailsWrapper, styles.loanLayout]}>
        <View style={[styles.loanDetails, styles.loanLayout]}>
          <View style={[styles.frameContainer, styles.loanDetailsPosition]}>
      ...
      <Pressable
        ...
        onPress={() => navigation.navigate("LoadingHomePayment")}
      >
      ...
      <View style={[styles.personalTextWrapper, styles.buttonPosition]}>
        <View style={[styles.personalText3, styles.loanDetailsPosition]}>
          <View>
      ...
      <View
        style={[styles.step3ConnectedHomeRepaymenItem, styles.step3Position]}
      />
...
const styles = StyleSheet.create({
  ...
  step3ConnectedHomeRepaymenChild: {
    top: 373,
  },
  pagoPrincipal: {
  ...
  step3ConnectedHomeRepaymenItem: {
    top: 673,
  },
  icon1: {
    width: 11,
...
export default Step3ConnectedHomeRepayment;
