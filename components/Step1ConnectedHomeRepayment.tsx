...
const Step1ConnectedHomeRepayment = () => {
  const navigation = useNavigation<StackNavigationProp<ParamListBase>>();

  return (
    <View style={styles.step1ConnectedHomeRepaymen}>
      <HeaderFooter
      ...
      <View style={[styles.personalLoan, styles.wrapperPosition]}>
        <View style={styles.personalText}>
          <View style={styles.frameParent}>
            <View style={styles.frameGroup}>
              <View
                style={[styles.prstamoDeCasaWrapper, styles.wrapperPosition1]}
              >
        ...
        <View style={[styles.personalTextParent, styles.personalSpaceBlock]}>
          <View style={styles.personalText2}>
            ...
            >
              <Text style={[styles.deDiciembreContainer, styles.text5Typo]}>
      ...
      <View
        style={[styles.step1ConnectedHomeRepaymenChild, styles.step1Position]}
      />
      <FrameComponent3 />
      ...
      <Pressable
        style={styles.button}
        onPress={() => navigation.navigate("Step2ConnectedHomeBankRepayment")}
      >
      ...
      <View
        style={[styles.step1ConnectedHomeRepaymenItem, styles.step1Position]}
      />
...
const styles = StyleSheet.create({
  ...
  step1ConnectedHomeRepaymenChild: {
    top: 373,
  },
  paso11: {
    color: Color.black,
  ...
  step1ConnectedHomeRepaymenItem: {
    top: 673,
  },
  icon1: {
    width: 11,
...
export default Step1ConnectedHomeRepayment;
