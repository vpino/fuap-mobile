...
const Step2EmptyBankPersonalRepayment = () => {
  const navigation = useNavigation<StackNavigationProp<ParamListBase>>();

  return (
    <View style={styles.step2EmptyBankPersonalRep}>
      <HeaderFooter
      ...
      <View style={[styles.personalLoan, styles.textWrapperPosition]}>
      ...
      <View
        style={[
          styles.step2EmptyBankPersonalRepChild,
          styles.personalChildBorder,
        ]}
      />
      <FrameComponent7 />
      <View style={[styles.textWrapper, styles.textWrapperPosition]}>
...
const styles = StyleSheet.create({
  ...
  step2EmptyBankPersonalRepChild: {
    marginLeft: -190.5,
    top: 373,
    left: "50%",
    width: 381,
...
export default Step2EmptyBankPersonalRepayment;
