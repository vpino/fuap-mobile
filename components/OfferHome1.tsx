    ...
    <View style={styles.offerHome}>
      <View style={styles.offerPersonal}>
        <Text style={[styles.ustedCalificPara, styles.ofertaATypo]}>
          Usted calificó para ofertas de préstamos:
        </Text>
        <View
          style={[
            styles.navigationMenuItemParent,
            styles.ofertaAWrapperFlexBox,
          ]}
        >
          <View
            style={[styles.navigationMenuItem, styles.navigationItemFlexBox]}
          >
            <View style={styles.navigationMenuItemInner}>
              <View
                style={[styles.ofertaAWrapper, styles.ofertaAWrapperFlexBox]}
              >
                <Text style={[styles.ofertaA, styles.ofertaATypo]}>
                  Oferta A
                </Text>
              </View>
            </View>
      ...
      <Buttons onButtonPress={() => navigation.navigate("RejectionPersonal")} />
    </View>
  );
};
