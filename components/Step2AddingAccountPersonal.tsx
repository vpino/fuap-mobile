...
const Step2AddingAccountPersonal = () => {
  const navigation = useNavigation<StackNavigationProp<ParamListBase>>();

  return (
    <View style={styles.step2AddingAccountPersonal}>
      <HeaderFooter
      ...
      <View
        style={[
          styles.step2AddingAccountPersonalChild,
          styles.confirmeTuCuentaPosition,
        ]}
      />
      ...
      <Text style={[styles.confirmeTuCuenta, styles.confirmeTuCuentaPosition]}>
        Confirme tu cuenta bancaria, numero de cuenta, y tu Código de Cuenta
        Interbancario para retirar su fondo.
      </Text>
      <Pressable
        style={[styles.inputBaseFieldParent, styles.parentWrapperPosition]}
        onPress={() => navigation.navigate("Step2AAddingAccountPersonal")}
      >
        <InputBaseField
          bank={require("../assets/bank.png")}
          seleccioneTuBanco="Seleccione tu Banco"
      ...
      >
        <InputBaseField
          bank={require("../assets/image-21.png")}
          seleccioneTuBanco="Cuenta Bancaria"
      ...
      <Button1
        ...
        icon={require("../assets/icon26.png")}
        showIcon={false}
...
const styles = StyleSheet.create({
  ...
  step2AddingAccountPersonalChild: {
    marginLeft: -190.5,
    top: 373,
    width: 381,
    height: 1,
...
export default Step2AddingAccountPersonal;
