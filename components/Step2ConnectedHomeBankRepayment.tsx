...
const Step2ConnectedHomeBankRepayment = () => {
  const navigation = useNavigation<StackNavigationProp<ParamListBase>>();

  return (
    <View style={styles.step2ConnectedHomeBankRep}>
      <HeaderFooter
      ...
      <View
        style={[styles.step2ConnectedHomeBankRepChild, styles.buttonPosition]}
      />
      <FrameComponent8 />
      ...
      <Pressable
        ...
        onPress={() => navigation.navigate("Step3ConnectedHomeRepayment")}
      >
...
const styles = StyleSheet.create({
  ...
  step2ConnectedHomeBankRepChild: {
    marginLeft: -190.5,
    top: 373,
    width: 381,
    height: 1,
...
export default Step2ConnectedHomeBankRepayment;
